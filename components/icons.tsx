...
export const Icons = {
  ...
  Logo: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 113;
    const computedHeight = size ?? height ?? 32;
  ...
  Apple: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 19;
    const computedHeight = size ?? height ?? 23;
  ...
  Google: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 20;
  ...
  InboxCustomize: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 17;
    const computedHeight = size ?? height ?? 17;
  ...
  Import: ({ size, ...props }: IconSvgProps) => {
  ...
  AlertCircle: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 16;
    const computedHeight = size ?? height ?? 17;
  ...
  Transactions2: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 40;
    const computedHeight = size ?? height ?? 40;
  ...
  Info: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 14;
    const computedHeight = size ?? height ?? 14;
  ...
  Github: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 22;
    const computedHeight = size ?? height ?? 22;
  ...
  Sidebar: ({ size, ...props }: IconSvgProps) => {
    const dimension = size ?? 24;
  ...
  SidebarFilled: ({ size, ...props }: IconSvgProps) => {
    const dimension = size ?? 24;
  ...
  Reconnect: ({ size = 24, ...props }: IconSvgProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      height={size}
  ...
  DotRaster: ({ size, width, height, ...props }: IconSvgProps) => {
    const computedWidth = size ?? width ?? 8;
    const computedHeight = size ?? height ?? 8;
  ...
  Gmail: ({ size, width, height, ...props }: IconSvgProps) => {
  ...
  CreateTransaction: ({ size, ...props }: IconSvgProps) => {
    const dimension = size ?? 24;
  ...
  ArrowCoolDown: ({ size, ...props }: IconSvgProps) => {
    const dimension = size ?? 24;
